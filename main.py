...
def attack(char_name: str, char_class: str) -> str:
    """Описывает нанесенные атаки противнику."""
    ...
    return 'Не верный тип атаки'


def defence(char_name: str, char_class: str) -> str:
    """Описывает сколько атак было заблокировано."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает какими умениями обладает герой."""
    if char_class == 'warrior':
    ...
    return 'Не корректное умение'


def start_training(char_name: str, char_class: str) -> str:
    """Описывает суть тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывает персонажей и происходит выбор игрока."""
    approve_choice: str = ''
    char_class: str = ''
